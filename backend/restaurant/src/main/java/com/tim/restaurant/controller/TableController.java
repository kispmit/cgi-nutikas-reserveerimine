...
public class TableController {
    ...
    public List<RestaurantTable> searchTables(
            ...
            @RequestParam(required = false) com.tim.restaurant.model.Zone zone,
    ...
    @PostMapping("/api/tables/recommend")
    public RecommendationResponse recommendTable(@RequestBody RecommendationRequest request) {
        return tableService.recommendTable(request);
    }
}